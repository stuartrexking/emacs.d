...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (move-text clj-refactor web-mode helm-projectile helm-ag helm avy yasnippet use-package solarized-theme rainbow-delimiters projectile parinfer paredit markdown-mode flx-ido company clojure-mode-extra-font-locking cider))))
(custom-set-faces
